...
#define	LINE_D04_LED4                  PAL_LINE(GPIOD, 4U)
...
#define	LINE_D10_SD_DETECT             PAL_LINE(GPIOD, 10U)
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(PD00_CAN_RX) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PD10_SD_DETECT) | \
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PD00_CAN_RX) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PD04_LED4) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PD10_SD_DETECT) | \
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_FLOATING(PD00_CAN_RX) | \
					 ...
					 PIN_PUPDR_PULLUP(PD10_SD_DETECT) | \
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_HIGH(PD00_CAN_RX) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PD10_SD_DETECT) | \
